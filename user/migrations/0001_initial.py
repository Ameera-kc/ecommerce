# Generated by Django 4.1.3 on 2022-11-10 09:00
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sub_banner1', versatileimagefield.fields.VersatileImageField(null=True, upload_to='SubBanners/')),
                ('sub_banner2', versatileimagefield.fields.VersatileImageField(null=True, upload_to='SubBanners/')),
            ],
        ),
        migrations.CreateModel(
            name='User',

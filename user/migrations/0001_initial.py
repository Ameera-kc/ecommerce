    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('products', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.addtocart')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ...
                ('is_top_save_today', models.BooleanField(blank=True, default=False, null=True)),
                ('is_best_seller', models.BooleanField(blank=True, default=False, null=True)),
                ('sub_image1', versatileimagefield.fields.VersatileImageField(blank=True, null=True, upload_to='products/')),
                ('sub_image2', versatileimagefield.fields.VersatileImageField(blank=True, null=True, upload_to='products/')),
                ('sub_image3', versatileimagefield.fields.VersatileImageField(blank=True, null=True, upload_to='products/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='user.product')),
            ],
        ),
        migrations.AddField(
            model_name='product',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coupon_code', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='user.coupon')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='user.customer')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(blank=True, max_length=254, null=True, verbose_name='Address')),
                ('contact', models.FloatField(blank=True, null=True, verbose_name='Contact')),
                ('products', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='user.addtocart')),
            ],
        ),
        migrations.AddField(

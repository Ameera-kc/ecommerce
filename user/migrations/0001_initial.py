    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wished_item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.product')),
            ],
        ),
        migrations.CreateModel(
            name='SubCategory',
        ...
        migrations.AddField(
            model_name='product',
            name='user',
            field=models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.CASCADE, to='user.customer'),
        ),
        migrations.CreateModel(
            name='HeaderFlash',
            fields=[
